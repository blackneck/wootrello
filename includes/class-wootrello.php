...
class Wootrello {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'woocommerce_order_status_changed',	$Wootrello_Settings, 'wootrello_woocommerce_order_status_changed', 100, 3 );		# Woocommerce Order Status Changed
    	$this->loader->add_action( 'woocommerce_new_order', 	 	  	$Wootrello_Settings, 'wootrello_woocommerce_new_order_admin', 100, 1 );				# WooCommerce New Order
    	$this->loader->add_action( 'woocommerce_thankyou', 	 	  		$Wootrello_Settings, 'wootrello_woocommerce_new_order_checkout', 100, 1 );				# WooCommerce New Order
		# AJAX Calls
